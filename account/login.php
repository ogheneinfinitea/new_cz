...
<head>
    ...
    <!-- Plugins CSS -->
    <link rel="stylestmlheet" href="assets/css/plugins/plugins.css">
 ...
 <?php
    ...
    ?>
       <div class="alert alert-danger" role="alert">
                                <strong>You Have Entered An Incorrect Login Details</strong> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="row justify-content-between">
                                                <div class="col-auto mb-15"><a href="reset-password.php">Forgot Password?</a></div>
                                                <div class="col-auto mb-15">Dont have account? <a href="register.php">Create Now.</a></div>
                                            </div>
                                        </div>
                                        <div class="col-12 mt-10"><button class="button button-primary button-outline" type="submit" name="login">sign in</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
