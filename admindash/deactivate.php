                    ...
                    <div class="col-lg-4 responsive-md-100">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">DEACTIVATE ACCOUNT</h4>
                                <?php
...
$query = mysqli_query($mysqli, "SELECT * FROM tbl_users WHERE  status='1'");
$query_display = mysqli_query($mysqli,"SELECT * FROM tbl_users WHERE  status='1'");
...
<?php }?>
                                        ...
                                        <button type="submit" name="activate"class="btn btn-success"> <i class="fa fa-key"></i> DEACTIVATE</button>
