...
<head>
    ...
    <title>Cztradingoptions -Dashboard</title>
...
<div class="container-fluid">
                    ...
                    <div class="col-lg-4 responsive-md-100">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">ACTIVATE ACCOUNT</h4>
                                <?php
                          ...
                          include("../db.php")
                            ...
                            <div class="card-body">
                                <form action="activate_process.php" method="post">
                                    <div class="form-body">
        ...
        <select id="user_status" name="user_status" class="form-control">
            ...
            <select name="user_bill">
<option>--please select person--</option>
<?php

$query = mysqli_query($mysqli, "SELECT * FROM tbl_users WHERE  status='0'");
$query_display = mysqli_query($mysqli,"SELECT * FROM tbl_users WHERE  status='0'");
...
<?php }?>
                                        ...
                                        <button type="submit" name="activate"class="btn btn-success"> <i class="fa fa-key"></i> ACTIVATE</button>
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2018 Cztradingoptions All Right Reserved.</footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
