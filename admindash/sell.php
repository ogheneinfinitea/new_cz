                    ...
                    <div class="col-lg-6 responsive-md-100">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">SELL COIN</h4>
                            </div>
                            <div class="card-body">
                                <form action="#">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Coin Ttype</label>
                                                    <select class="form-control" data-placeholder="Choose a Category" tabindex="1">
                                                        <option value="Category 1">Bitcoin (BTC)</option>
                                                        <option value="Category 2">Litecoin (LTC</option>
                                                        <option value="Category 3">Ethereum (ETH)</option>
                                                        <option value="Category 4">Ripple (XRP)</option>
                                                    </select>
                                                </div>
                                            </div>
                                        <!--/row-->
                                        ...
                                        <button type="submit" class="btn btn-success"> <i class="fa fa-check"></i> BUY</button>
