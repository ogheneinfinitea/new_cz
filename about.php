...
<html lang="zxx" class="js">
	<head>
		...
		<!-- Site Title  -->
		<title>Cztrazdingoptions | ABOUT US </title>
		<!-- Vendor Bundle CSS -->
       			...
       			<div class="row row-vm">
       				...
       				<div class="col-md-6 col-md-offset-1">
       					<div class="video-block round">
       						<img src="pix/bitrediff_two.jpg" alt="Bitrediff" class="">
       			...
       			<div class="section-head">
					<div class="row text-center">
						<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
							...
							<p>Our mining pool has been in operation since 2014. Since then we’ve deployed 500 petahash (514.84 PH/s) and we’ve mined more than
								 70,000 coins—we invest in even more resources, servers, and high-end mining software to scale up operations to continue to deliver results.</p>
						</div>
					</div>
       			</div>
       ...
       <!-- 	<div class="section section-pad">
    	...
    	<div class="section section-pad cta-section light has-bg dark-filter">
    		<div class="imagebg has-parallax">
				<img src="pix/bitrediff_buy.jpg" alt="Bitrediff">
			</div>
    		<div class="container">
    			<div class="row text-center">
    				<div class="col-md-8 col-md-offset-2">
    					<h3>Are you searching for a quick, cheap, and safe way to buy Bitcoins? </h3>
    					<a href="buy-sell.php" class="btn btn-md">buy bitcoin</a>
    				</div>
    			</div>
    		</div>
    	</div>
       		...
       		<div class="container">
       			...
       			<div class="row text-center">
       				<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
       					<div class="team-member">
       						<div class="team-thumb">
       							<img src="pix/bitrediff_team1.jpg" alt="team-thumb">
       				...
       				<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
       					<div class="team-member">
       						<div class="team-thumb">
       							<img src="pix/bitrediff_team2.png" alt="team-thumb">
       							<div class="team-thumb-overlay">
       								<!-- <ul class="team-social">
       									<li><a href="#"><span class="fa fa-facebook"></span></a></li>
       									<li><a href="#"><span class="fa fa-twitter"></span></a></li>
       				...
       				<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
       					<div class="team-member">
       						<div class="team-thumb">
       							<img src="pix/bitrediff_team3.jpg" alt="team-thumb">
       							<div class="team-thumb-overlay">
       								<!-- <ul class="team-social">
       									<li><a href="#"><span class="fa fa-facebook"></span></a></li>
       									<li><a href="#"><span class="fa fa-twitter"></span></a></li>
       						...
       						<div class="team-info">
       							...
       							<span class="team-title">Broker</span>
       						</div>
       					</div>
       				</div>
       			</div>
