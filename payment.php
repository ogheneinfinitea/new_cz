...
<html lang="zxx" class="js">
	<head>
		...
		<!-- Site Title  -->
		<title>Cztradingoptions |  PAYMENT </title>
		<!-- Vendor Bundle CSS -->
       			...
       			<div class="row row-vm">
       				<div class="col-md-5 res-m-bttm">
						<div class="text-block">
							...
							<ul>
								<li>Login to your acccount  <a href="http://localhost/new_cz/login.php">Account Login</a>.</li>
								<li>Click on Buy and Sell Button</li>
								<li> Click on Deposit  </li>
								<li>Enter Preferred Amount in Pounds (Bitcoin Equivalence)</li>
                                <li>Click on Deposit</li>
                                <li>Make Payment into the Displayed Bitcoin Address or Scan the QR code</li>
							</ul>
