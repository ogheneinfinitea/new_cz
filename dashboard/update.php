                    ...
                    <div class="col-lg-9">
                        <div class="card">
                            ...
                            //   echo $session_username; 
                              $sql="SELECT id, username,name,email,country,phone FROM tbl_users WHERE username ='$session_username'";
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="fullname" name="name" placeholder="Enter  Fullname.." value="<?php echo $row['name']; ?>">                                </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-currency">Email <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email" value="<?php echo $row['email']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-currency">Country <span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-currency" name="country" placeholder="Enter Country" value="<?php echo $row['country']; ?>">
                                            </div>
                                        </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-phoneus" name="phone" placeholder="212-999-0000" value="<?php echo $row['phone']; ?>">
                                            </div>
                                        </div>
...
if (isset($_POST['update'])) {
    ...
    $sql=("UPDATE  tbl_users SET name='$name', email= '$email', country='$country', phone='$phone' WHERE username='$session_name' ");
