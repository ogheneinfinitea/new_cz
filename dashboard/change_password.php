                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="password" class="form-control" id="val-username" name="val-username" placeholder="Enter Password..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email"> Confirm_Password<span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="password" class="form-control" id="val-email" name="val-email" placeholder="Enter Password Again..">
                                            </div>
                                        </div>
