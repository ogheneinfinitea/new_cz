								...
								<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
									...
									<form class="form-signup" action="" method="post">
										...
										<div class="form-group">
											...
											<div class="form-group">
											<div class="form-field form-m-bttm">
												<input name="occupation" type="occupation" placeholder="Occupation *" class="form-control required email" aria-required="true">
											</div>
                                        </div>
                                        <div class="form-group">
											<div class="form-field form-m-bttm">
												<input name="mobile" type="mobile" placeholder="Mobile No *" class="form-control required email" aria-required="true">
											</div>
                                        </div>
                                        <select name="quote-request-hear"  id="state-list" class="form-control" aria-invalid="false">
