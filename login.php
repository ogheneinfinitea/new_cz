...
$revenue="0";
           ...
           $sql = "INSERT INTO tbl_users (firstname,lastname,username,email,address,mobile,password,country)
           VALUES ('$firstname','$lastname','$username','$email','$address','$mobile','$password','$country')";
									...
									<form class="form-signup" action="" method="post">
										...
										<div class="form-group">
											<div class="form-field form-m-bttm">
												<input name="username" type="username" placeholder="username *" class="form-control required email" aria-required="true">
											</div>
										</div>
										<div class="form-group">
										...
										<button type="submit" name="signin" class="btn btn-alt">Log In</button>
							...
							<div class="row">
								<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
									...
									<form class="form-signup" action="" method="post">
										...
										<div class="form-group">
											<div class="form-field">
												<input name="firstname" type="text" placeholder="Firstname *" class="form-control required" aria-required="true">
											</div>
										</div>
										<div class="form-group">
											<div class="form-field">
												<input name="lastname" type="text" placeholder="Lastname *" class="form-control required" aria-required="true">
											</div>
										</div>
											<div class="form-group">
											<div class="form-field form-m-bttm">
												<input name="username" type="text" placeholder="Username *" class="form-control required email" aria-required="true">
											</div>
										</div>
										<div class="form-group">
											<div class="form-field form-m-bttm">
								...
								<!-- <div class="form-field form-m-bttm">
									<select name="category"  id="state-list" class="form-control" aria-invalid="false">
										<option value="">SELECT CATEGORY</option>
											<option value="SWING TRADE METHOD">SWING TRADE METHOD</option>
											<option value="DAY TRADE METHOD">DAY TRADE METHOD</option>
											<option value="SCALPE TRADE METHOD">SCALPE TRADE METHOD</option>
											<option value="HIGH RISK TRADE METHOD">HIGH RISK TRADE METHOD</option>
											...
											<!-- <div class="form-group">
											<div class="form-field">
												<input name="occupation" type="text" placeholder="Occupation *" class="form-control required" aria-required="true">
											</div>
										</div>
											<div class="form-group">
											<div class="form-field form-m-bttm">
												<input name="years" type="text" placeholder="Years of Trading" class="form-control required email" aria-required="true">
											</div>
										</div> -->
										<div class="form-group">
											<div class="form-field">
												<input name="address" type="text" placeholder="Address *" class="form-control required" aria-required="true">
											</div>
										</div>
											<div class="form-group">
											<div class="form-field form-m-bttm">
												<input name="mobile" type="text" placeholder="Mobile Number" class="form-control required email" aria-required="true">
											</div>
										</div>

							<select name="country"  id="state-list" class="form-control" aria-invalid="false">
...
<option value="Zimbabwe">Zimbabwe</option>
										...
										<div class="form-group">
											<div class="form-field">
												<input name="c_password" type="password" placeholder="Confirm Password *" class="form-control required" aria-required="true">
											</div>
										</div>
										...
										<button type="submit" class="btn btn-alt" name="register">Sign Up</button>
										<span class="gaps"></span>
										<p class="small">Already Have  an Account ?  <a class="switch-tab" data-tabnav="loginreg-form" href="sign.php" >Log In</a></p>
									</form>
								</div>
							</div>
						</div>
